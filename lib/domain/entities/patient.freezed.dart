...
class _$PatientImpl implements _Patient {
  ...
  @override
  String toString() {
    return 'Patient(id: $id, name: $name, email: $email, phone: $phone, cpf: $cpf, rg: $rg)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, email, phone, cpf, rg);
...
abstract class _Patient implements Patient {
  const factory _Patient(
      ...
      @HiveField(5) final String? rg}) = _$PatientImpl;
